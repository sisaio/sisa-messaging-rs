...
manifests, migrations, or tests needed to trace a concrete risk.
...
shell commands with rtk. Report findings by severity with location, observable risk, test gap, and
