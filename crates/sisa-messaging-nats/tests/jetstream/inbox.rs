//! Test-local transactional inbox used to run the generic consumer over real JetStream.
//!
...
#![allow(
    dead_code,
    reason = "the JetStream tests and the consume benchmark each use a subset"
)]
